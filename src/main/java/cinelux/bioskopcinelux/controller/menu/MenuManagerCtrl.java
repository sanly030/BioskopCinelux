...
public class MenuManagerCtrl implements Initializable {
    @FXML
    ...
    @FXML
    private HBox menuReportMenu;
    @FXML
    private StackPane rootPane;
    @FXML
    private HBox ticketReportMenu;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        loadMaster("/cinelux/bioskopcinelux/view/DashboardManager/DashboardManager.fxml");
    ...
    private void updateTitleAndImage(String headTitleText, String subTitleText, String imagePath) {
        ...
        if (imgTittle != null) {
            ...
            try {
                if (imagePath != null && !imagePath.isEmpty()) {
                    imageStream = getClass().getResourceAsStream("/cinelux/bioskopcinelux/image/LogoLaporan/"+imagePath);
                }
    ...
    @FXML
    void handleDashboardManagerClick(MouseEvent event) {
        loadMaster("/cinelux/bioskopcinelux/view/DashboardManager/DashboardManager.fxml");
        setActiveMenu(dashboardMenu);
        updateTitleAndImage("Report Transaction","Report","LogoDashboard.png");
    }

    @FXML
    void handleReportMenuClick(MouseEvent event) {
        loadMaster("/cinelux/bioskopcinelux/view/DashboardManager/ReportTransaksiMenu.fxml");
        setActiveMenu(menuReportMenu);
        updateTitleAndImage("Report Transaction Menu","Read Transaction Menu","LogoMenuReport.png");
    }

    @FXML
    void handleReportTiketClick(MouseEvent event) {
        loadMaster("/cinelux/bioskopcinelux/view/DashboardManager/ReportTransaksiTiket.fxml");
        setActiveMenu(ticketReportMenu);
